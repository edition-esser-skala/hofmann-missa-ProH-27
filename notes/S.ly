...
SanctusSoprano = {
  \relative c' {
    ...
    r2 d4 d
    R1*2 %6
    es4 es des8 des16 des des8 des
    c8. c16 c4 b8 b16 b b8 b \noBreak
    b4( a8) a b2\fermata \bar "||"
    \time 4/4 \tempoPleni b4 b8 b d es r4 \noBreak %10
    es es8 es es d b4~
    b as2 g4
    f8 g16 g f4 es r8 b'
    es8. d16 c8 b as as r as
    f'8. d16 b8 as g g r g %15
    c8. b16 as8 g f f g as
    g4( f) es r8 b'
...
BenedictusSoprano = {
  \relative c' {
    ...
    d4 b c2 %20
    b as4. as8
    g b es4. es16 es es8 d
    es4 g, as8 g16 g f8. f16
    es4 r r2
    r r4 r8 b' %25
