...
SanctusViolinoI = {
  \relative c' {
    ...
    es'4\f es r2
    f,2~\p f8 es16 d es8 f16 g
    as4~ as16 f' d as g4~ g16 c es g
    f es es8~ es16 c' a es d4\f d
    r2 c4~\p c16 f as c, %5
    b4~ b16 es g b, as4~ as16 d f as,
    <g es'>4\f q des'~ des16 g b des,
    c4~ c16 f as f b,4~ b16 g' f b, \noBreak
    b4 a16( c es c) b d,( f d) b4\fermata \bar "||"
    \time 4/4 \tempoPleni <f' d' b'> \tuplet 6/4 4 { \sbOn f'16 es d d c b \sbOff } d8-! es-! r4 \noBreak %10
    <g b, es,>4 \tuplet 6/4 4 { es,16 g f es d es } es'8 d b'16 b,8 b'16
    b c,8 b'16 as f,8 as'16 as b,8 as'16 g es,8 g'16
    f16.^\critnote as,32 g16. es'32 f,8 d' es,4 r8 b'
    es8. d16 c8 b as as r as
    f'8. d16 b8 as g g r g %15
    c8. b16 as8 g f f'16. as,32 g16. es'32 c16. as32
    \tuplet 6/4 4 { g16 g' f es d es } f,8 d' es,4 r8 b'
    c8. b16 c8 des c b r b
    c( b) es( des) c2
...
BenedictusViolinoI = {
  \relative c' {
    ...
    as( g f es) es'8 es32( b g' f es b as g) g8\trill f r4
    b,16(\sf as') as8 as32( g f es d es d es) b16(\sf as') as8 as32( g f es d es d es)
    f( as b as as g f es) b8 f' g'16(\sf es) es8 es16 d32( es f es d es)
    g16(\sf es) es8 es16 d32( es f es d es) c16. d32 es([ b g es)] f4\trill %5
    ...
    d16(\sf b) b8 b16 a32( b c b a b) d16(\sf b) b8 b16 a32( b c b a b)
    g16. a32 b32([ f d b)] c4\trill <b d,>8 b-\critnote b32( d c b a b a b)
    ...
    es,16 es'8 es g b16 as32([ f d b)] g'( es b g) f8 d'
    g16(\sf es) es8 es16 d32( es f es d es) g16(\sf es) es8 es16 d32( es f es d es)
    c16. d32 es([ b g es)] f4\trill es r8 b' %25
    \tempoOsanna es8. d16 c8 b as as r as
    f'8. d16 b8 as g g r g
    c8. b16 as8 g f f'16. as,32 g16.^\critnote es'32 c16. as32
    \tuplet 6/4 4 { g16 g' f es d es } f,8 d' es,4 r8 b'
    c8. b16 c8 des c b r b %30
    c( b) es( des) c2
    b1\fermata \bar "|." %32 finis
  }
}
...
AgnusViolinoI = {
  \relative c' {
    ...
    R1*6 %6
    es'4.\fE d16( c) c8 h r d
    d f,16 f f8 f f es r16 es\p es es
    r e e e r e e e r es es es r es es es
    r es es es r d d d es4 r %10
    R1*2
    r2 b'4.\f es8
    es( d) r d d as g f
    f es r16 g\p g g r as as as r as as as %15
    ...
    \time 4/4 \tempoDona
      es'16 es, es es es es' es es es es, es es es es' es es \noBreak
    c c, c c c c' c c d b, b b b f'' f f
    g es, es es es es' es es es c, c c c c' c c %25
    d b, b b \kneeBeam b b'' b b b b, b b b b d b
    g' g, g g g g' g g f f, f f f c' c c
    d b, b b b f'' f f f b,, b b \kneeBeam b as''! as as
    g es, es es es es' es es es es, es es es es' es es
    ...
    g es, es es es es' es es es c, c c c c' c c
    d b, b b b f'' f f f b,, b b b f'' f f
    g es, es es es g' g g g es, es es es g' g g %35
    c, c, c c c c' c c d d, d d d d' d d
    es es, es es es es' es es es f, f f f es' es es
    d b, b b b des' des des des f, f des' des es, es des'
    c as, as as as c' c c c es, es c' c d,! d c'
    ...
    c2 c8( a) \once \tieDashed b4~
    \once \slurDashed b8( g) as4. c16 b b( as g as)
    g4(\f f) r8 \once \slurDashed f16( d) d'( h f d) %50
    \once \slurDashed es4( d) r8-\critnote g, es'4~
    es8 d16 es f8 es d2
    es16 b'(\p c b) b, as'( b as) as( g f es d c b as)
    g\f es es es es es' es es es es, es es es es' es es
    c c, c c c c' c c d b, b b b f'' f f %55
    g es, es es es es' es es es c, c c c c' c c
    d b, b b \kneeBeam b b'' b b b b, b b b b d b
    g' g, g g g g' g g f f, f f f c' c c
    d b, b b b f'' f f f b,, b b \kneeBeam b as''! as as
    ...
    b b, b b b b' b b b b, b b b b' b b
    g es, es es es es' es es c c, c c c c' c c
    d b, b b b f'' f f f b,, b b b f'' f f %65
    g es, es es es g' g g g es, es es es g' g g
    c, c, c c c c' c c d d, d d d d' d d
    es es, es es es es' es es es f, f f f es' es es
    d b, b b b d' d d e c, c c c e' e e
